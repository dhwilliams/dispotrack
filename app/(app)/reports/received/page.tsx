...
import { ReceivedReport } from "@/components/reports/received-report"
...
export default function ReceivedReportPage() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      saveRecentReport({
        ...
        transactionNumber: transaction.transaction_number,
        customerName: client.name,
        href: `/reports/received?txn=${encodeURIComponent(transaction.transaction_number)}`,
      })
    } catch {
  ...
  // If we have report data, show the report
  if (reportData) {
    return (
      <div>
  ...
  return (
    <div className="space-y-6">
      <div className="no-print">
        <PageHeader
          title="Assets Received by Transaction"
          description="Generate a listing of all assets received in a transaction"
        />
      </div>
